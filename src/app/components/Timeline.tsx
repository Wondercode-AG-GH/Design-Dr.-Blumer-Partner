    ...
    >
      ...
      >
        ...
        <span
          ...
          className="text-[7px] md:text-[8px] uppercase mt-3 block text-center"
        >
          {milestone.label}
        </span>
        ...
        {isExpanded && milestone.expandedText && (
          <p
            ...
            className="text-[10px] mt-3 max-w-[280px]"
          >
...
function TimelineHeader({ scrollX }: { scrollX: number }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute left-0 top-0 bottom-0 flex flex-col justify-center pl-10 md:pl-20 lg:pl-32 z-20"
      style={{
    ...
    >
      ...
      >
        <span
          ...
          className="text-[8px] md:text-[9px] uppercase block mb-10"
        >
          Unsere Geschichte
        </span>
        ...
        <span
          ...
          className="text-[clamp(1.5rem,2.8vw,2.8rem)] tracking-[-0.02em] block"
        >
          1996
        </span>
        <span
        ...
        <p
          ...
          className="text-[10px] max-w-[220px] mt-6"
        >
          Drei Jahrzehnte konsequenter Entwicklung. Jeder Schritt auf dem
          gleichen Fundament.
        </p>
      </div>
    </div>
...
export function EditorialTimeline({ scrollX }: { scrollX: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Soft edge blends */}
      <div
        className="absolute inset-y-0 left-0 w-[6vw] pointer-events-none z-10"
        style={{
          background: `linear-gradient(to right, ${C.bg}, transparent)`,
        }}
      />
      <div
        className="absolute inset-y-0 right-0 w-[6vw] pointer-events-none z-10"
        style={{
